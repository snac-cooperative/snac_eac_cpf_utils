...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                >
    <!-- 
         Included in oclc_marc2cpf.xsl and written to files by template tpt_body. In general, only the minimum amount of
         code is here, leaving this file as clean as possible.
    -->
